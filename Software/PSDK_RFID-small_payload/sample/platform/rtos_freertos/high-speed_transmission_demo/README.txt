...
Step 1 : build source file, use following cmd:
...
Step 2 : Manifold should connect to Skyport 2.0/XPort via network cable and connect to RTOS development board
...
Step 3 : make sure the RTOS environment is ok and enable the camera function to run the RTOS sample

Step 4 : use the root permission to execute this program, use following cmd:
sudo ./high-speed_transmission_demo

Step 5 : use DJI Pilot APP/MSDK APP to see video stream and receive test data